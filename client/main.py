...
def main():
    ...
    '''This command handles displaying all items in the inventory'''
    ...
    '''This command handles displaying details of one item that is selected by id'''
    ...
    '''This command handles adding a new item to the inventory'''
    ...
    '''This command handles updating the name or brands of an item that is selected by id'''
    ...
    '''This command handles removing an item that is selected by id from the inventory'''
    ...
    '''This part handles displaying the help menu when no argument is provided by the user'''
